...
if(komodo_speech_CONFIG_INCLUDED)
  return()
endif()
set(komodo_speech_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(komodo_speech_SOURCE_PREFIX /home/neowizard/school/komodo/komodo_speech/src/komodo_speech)
  set(komodo_speech_DEVEL_PREFIX /home/neowizard/school/komodo/komodo_speech/devel)
  set(komodo_speech_INSTALL_PREFIX "")
  set(komodo_speech_PREFIX ${komodo_speech_DEVEL_PREFIX})
else()
  set(komodo_speech_SOURCE_PREFIX "")
  set(komodo_speech_DEVEL_PREFIX "")
  set(komodo_speech_INSTALL_PREFIX /home/neowizard/school/komodo/komodo_speech/install)
  set(komodo_speech_PREFIX ${komodo_speech_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'komodo_speech' is deprecated")
...
set(komodo_speech_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/neowizard/school/komodo/komodo_speech/devel/include " STREQUAL " ")
  set(komodo_speech_INCLUDE_DIRS "")
  set(_include_dirs "/home/neowizard/school/komodo/komodo_speech/devel/include")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${komodo_speech_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'komodo_speech' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Lior Zur-Lotan <llutan@cs.bgu.ac.il>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'komodo_speech' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neowizard/school/komodo/komodo_speech/src/komodo_speech/${idir}'.  Ask the maintainer 'Lior Zur-Lotan <llutan@cs.bgu.ac.il>' to fix it.")
    endif()
    _list_append_unique(komodo_speech_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND komodo_speech_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(komodo_speech_LIBRARY_DIRS ${lib_path})
      list(APPEND komodo_speech_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'komodo_speech'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND komodo_speech_LIBRARIES ${lib})
    endif()
  endif()
...
set(komodo_speech_EXPORTED_TARGETS "komodo_speech_generate_messages_cpp;komodo_speech_generate_messages_lisp;komodo_speech_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${komodo_speech_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 komodo_speech_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${komodo_speech_dep}_FOUND)
      find_package(${komodo_speech_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${komodo_speech_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(komodo_speech_INCLUDE_DIRS ${${komodo_speech_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(komodo_speech_LIBRARIES ${komodo_speech_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${komodo_speech_dep}_LIBRARIES})
  _list_append_deduplicate(komodo_speech_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(komodo_speech_LIBRARIES ${komodo_speech_LIBRARIES})

  _list_append_unique(komodo_speech_LIBRARY_DIRS ${${komodo_speech_dep}_LIBRARY_DIRS})
  list(APPEND komodo_speech_EXPORTED_TARGETS ${${komodo_speech_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "komodo_speech-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${komodo_speech_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
